...
public class DacastAudioSermonAdapter extends RecyclerView.Adapter<DacastAudioSermonAdapter.DacastAudioSermonViewHolder> {

    List<DacastAudioSermonEntity> list = new ArrayList<>();;
    @Inject
    Context context;


    public DacastAudioSermonAdapter(SelectedChurchViewModel viewModel, LifecycleOwner lifecycleOwner,
                                    Context context) {
        this.context = context;
        viewModel.getAudioRepos().observe(lifecycleOwner, repos -> {
            if (list != null) {
                list.clear();
            }
    ...
    @NonNull
    @Override
    public DacastAudioSermonAdapter.DacastAudioSermonViewHolder onCreateViewHolder(@NonNull ViewGroup parent,
                                                                               int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.selected_church_online_list_item,
                parent, false);
        return new DacastAudioSermonAdapter.DacastAudioSermonViewHolder(view);
    }

    @Override
    public void onBindViewHolder(DacastAudioSermonAdapter.DacastAudioSermonViewHolder holder, int position) {

        DacastAudioSermonEntity churchVod = list.get(position);
        ...
        // OnClickListener for menu options
    ...
    public static class DacastAudioSermonViewHolder extends RecyclerView.ViewHolder {
        ...
        public DacastAudioSermonViewHolder(View itemView) {
            super(itemView);
