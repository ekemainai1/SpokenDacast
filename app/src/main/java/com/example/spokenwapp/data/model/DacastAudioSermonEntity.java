...
@Entity(tableName = "dacastaudioSermonlog_table", indices = {@Index(value = {"contentIds"}, unique = true)})
public class DacastAudioSermonEntity {
        ...
        @Ignore
        public DacastAudioSermonEntity(int id, String contentIds, String totalCount, Integer abitrate,
        ...
        public DacastAudioSermonEntity(String contentIds, String totalCount, Integer abitrate,
                                       String acodec, String ads, String associatedPackages, Integer categoryId,
                                       String container, Integer countriesId, String creationDate, String customData,
                                       Integer noframeSecurity, String description, String diskUsage, String duration,
                                       Boolean autoplay, Boolean enableCoupon, Boolean online, Boolean enablePayperview,
