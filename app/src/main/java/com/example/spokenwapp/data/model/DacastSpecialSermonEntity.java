...
@Entity(tableName = "dacastspecialsSermonlog_table", indices = {@Index(value = {"contentIds"}, unique = true)})
public class DacastSpecialSermonEntity {
    ...
    @Ignore
    public DacastSpecialSermonEntity(int id, String contentIds, String totalCount, Integer abitrate,
    ...
    public DacastSpecialSermonEntity(String contentIds, String totalCount, Integer abitrate,
                                     String acodec, String ads, String associatedPackages, Integer categoryId,
                                     String container, Integer countriesId, String creationDate, String customData,
                                     Integer noframeSecurity, String description, String diskUsage, String duration,
                                     Boolean autoplay, Boolean enableCoupon, Boolean online, Boolean enablePayperview,
