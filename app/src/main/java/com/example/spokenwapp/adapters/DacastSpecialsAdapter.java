...
public class DacastSpecialsAdapter extends RecyclerView.Adapter<DacastSpecialsAdapter.DacastSpecialsViewHolder> {

    List<DacastSpecialSermonEntity> list = new ArrayList<>();;
    @Inject
    Context context;


    public DacastSpecialsAdapter(SelectedChurchViewModel viewModel, LifecycleOwner lifecycleOwner,
                                    Context context) {
        this.context = context;
        viewModel.getSpecialsRepos().observe(lifecycleOwner, repos -> {
            if (list != null) {
                list.clear();
            }
    ...
    @NonNull
    @Override
    public DacastSpecialsAdapter.DacastSpecialsViewHolder onCreateViewHolder(@NonNull ViewGroup parent,
                                                                                   int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.selected_church_online_list_item,
                parent, false);
        return new DacastSpecialsAdapter.DacastSpecialsViewHolder(view);
    }

    @Override
    public void onBindViewHolder(DacastSpecialsAdapter.DacastSpecialsViewHolder holder, int position) {

        DacastSpecialSermonEntity churchVod = list.get(position);
    ...
    public static class DacastSpecialsViewHolder extends RecyclerView.ViewHolder {
        ...
        public DacastSpecialsViewHolder(View itemView) {
            super(itemView);
